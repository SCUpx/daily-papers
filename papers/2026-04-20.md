...
### 1. **[Towards Universal Convergence of Backward Error in Linear System Solvers](https://arxiv.org/abs/2604.16075v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-17
- **作者**: Michał Dereziński, Yuji Nakatsukasa, Elizaveta Rebrova
- **标签**: `math.NA` `cs.DS` `cs.LG`
- **AI摘要**: 提出基于后向误差的线性系统求解新算法
<details>
...
- **评分理由**: 突破了条件数限制，实现了通用收敛速率

### 2. **[Breaking the Training Barrier of Billion-Parameter Universal Machine Learning Interatomic Potentials](https://arxiv.org/abs/2604.15821v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-17
- **作者**: Yuanchang Zhou, Hongyu Wang, Yiming Du et al.
- **标签**: `cs.DC` `cs.LG`
- **AI摘要**: 提出MatRIS-MoE与Janus框架，实现十亿参数MLIP高效训练
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 在Exascale系统上实现重大算力突破，显著缩短训练周期

### 3. **[When Do Early-Exit Networks Generalize? A PAC-Bayesian Theory of Adaptive Depth](https://arxiv.org/abs/2604.15764v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-17
- **作者**: Dongxin Guo, Jikun Wu, Siu Ming Yiu
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出早退神经网络的PAC-Bayesian泛化理论框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，边界推导严谨，实验验证充分且结果显著。

### 4. **[Faster LLM Inference via Sequential Monte Carlo](https://arxiv.org/abs/2604.15672v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-17
- **作者**: Yahya Emara, Mauricio Barba da Costa, Chi-Chih Chang et al.
- **标签**: `cs.LG` `cs.CL`
- **AI摘要**: 提出SMC-SD算法加速大模型推理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入重采样机制，显著提升推理效率且理论严谨

### 5. **[StoSignSGD: Unbiased Structural Stochasticity Fixes SignSGD for Training Large Language Models](https://arxiv.org/abs/2604.15416v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-16
- **作者**: Dingzhi Yu, Rui Pan, Yuxing Liu et al.
- **标签**: `cs.LG` `cs.AI` `math.OC`
- **AI摘要**: 提出StoSignSGD解决大模型训练中SignSGD收敛问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且在LLM训练中展现出显著的性能提升与稳定性

## Mixed lubrication

### 1. **[Probabilistic Upscaling of Hydrodynamics in Geological Fractures Under Uncertainty](https://arxiv.org/abs/2604.15785v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Sarah Perez, Florian Doster, Hannah Menke et al.
- **标签**: `physics.comp-ph` `physics.flu-dyn`
- **AI摘要**: 提出裂隙流体概率尺度提升方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合贝叶斯与深度学习，有效量化裂隙流体不确定性。

### 2. **[A shifted interface approach for internal discontinuities in poroelastic media](https://arxiv.org/abs/2604.15450v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-16
- **作者**: David Michael Riley, Guglielmo Scovazzi, Ioannis Stefanou
- **标签**: `cs.CE` `physics.comp-ph` `physics.geo-ph`
- **AI摘要**: 提出位移界面法模拟多孔介质裂纹
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且验证充分，但未涉及指定分类领域

### 3. **[SHIELD: A Reference Gas-Driven Permeation Platform for Hydrogen Permeation Studies](https://arxiv.org/abs/2604.15407v1)**
- **评分**: ⭐ 71/100 | **日期**: 2026-04-16
- **作者**: James Dark, Colin Weaver, Remi Delaporte-Mathurin et al.
- **标签**: `physics.ins-det` `cond-mat.mtrl-sci`
- **AI摘要**: 开发了核聚变材料氢渗透研究参考平台SHIELD。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验验证严谨，实用性强，但缺乏理论突破。

### 4. **[Towards Non-van der Waals 2D Topological Insulators](https://arxiv.org/abs/2604.14976v1)**
- **评分**: ⭐ 71/100 | **日期**: 2026-04-16
- **作者**: Mani Lokamani, Gustav Bihlmayer, Gregor Michalicek et al.
- **标签**: `cond-mat.mtrl-sci` `physics.comp-ph`
- **AI摘要**: 提出并验证了非范德华2D拓扑绝缘体材料
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导完整，开辟新方向，但无实验支撑

## EHL

### 1. **[Discovering quantum phenomena with Interpretable Machine Learning](https://arxiv.org/abs/2604.16015v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-17
- **作者**: Paulin de Schoulepnikoff, Hendrik Poulsen Nautrup, Hans J. Briegel et al.
- **标签**: `quant-ph` `cond-mat.stat-mech` `cs.LG`
- **AI摘要**: 利用可解释机器学习发现量子新现象
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖性高，实用性强，方法严谨，表述清晰，总分高。

### 2. **[JumpLoRA: Sparse Adapters for Continual Learning in Large Language Models](https://arxiv.org/abs/2604.16171v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Alexandra Dragomir, Ioana Pintilie, Antonio Barbalau et al.
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: JumpLoRA通过JumpReLU实现LoRA稀疏化以促进持续学习
<details>
<summary>原始摘要</summary>
...
- **评分理由**: JumpLoRA通过引入JumpReLU实现LoRA稀疏化，有效解决了持续学习中的灾难性遗忘问题，并显著提升了模型性能，具有较高的创新性和实用性。

### 3. **[Reweighting Estimators for Density Response in Path Integral Monte Carlo: Applications to linear, nonlinear and cross-species density response](https://arxiv.org/abs/2604.15934v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-17
- **作者**: Pontus Svensson, Thomas Chuna, Jan Vorberger et al.
- **标签**: `physics.chem-ph` `physics.comp-ph` `physics.plasm-ph`
- **AI摘要**: 提出基于重加权的密度响应蒙特卡洛估计算法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且严谨，在量子多体系统模拟中具有应用潜力

### 4. **[Fully compensated and uncompensated ferrimagnetic ferrovalley semiconductors](https://arxiv.org/abs/2604.15640v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-17
- **作者**: Weifeng Xie, Libo Wang, Yunliang Yue et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 提出铁磁铁谷半导体及谷霍尔效应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，理论严谨，对谷电子学有重要指导意义。

### 5. **[UA-Net: Uncertainty-Aware Network for TRISO Image Semantic Segmentation](https://arxiv.org/abs/2604.15542v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-16
- **作者**: Kyle Lucke, Zuzanna Krajewska-Travar, Shoukun Sun et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出UA-Net实现TRISO燃料微观图像语义分割与不确定性量化。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型创新性结合不确定性感知，实验验证充分且精度高，具有工业应用潜力。

## Super Lubricating

### 1. **[Experimental quantification of electronic symmetry breaking through orbital hybridization phase](https://arxiv.org/abs/2604.15906v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-17
- **作者**: Shungo Aoyagi, Shunsuke Kitou, Yuiga Nakamura et al.
- **标签**: `cond-mat.str-el` `cond-mat.mtrl-sci`
- **AI摘要**: 提出量化电子对称性破缺的实验框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过轨道杂化相位量化对称性破缺，具有极高的理论与实验价值。

### 2. **[Antiferromagnetic Dimers in the Parent Phase of a Correlated Kagome Superconductor](https://arxiv.org/abs/2604.15935v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Yifan Wang, Chenchao Xu, Yi Liu et al.
- **标签**: `cond-mat.str-el` `cond-mat.mtrl-sci`
- **AI摘要**: 揭示CsCr3Sb5中反铁磁二聚体对超导配对的作用
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过晶体结构解析与第一性原理计算，阐明了关联Kagome超导体的微观机制。

### 3. **[Persistence of large and gate-tunable anisotropic magnetoresistance in an atomically thin antiferromagnet](https://arxiv.org/abs/2604.15793v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Cheol-Yeon Cheon, Kenji Watanabe, Takashi Taniguchi et al.
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 实现超薄反铁磁体电学读写与栅极调控
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 在二维反铁磁材料中实现了高灵敏度磁阻效应，实验设计严谨且具有重要应用前景。

### 4. **[Facet-dependent Chemical Kinetics Governed Growth of Twisted Graphene Layers with Pre-designed Angles](https://arxiv.org/abs/2604.15639v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Chaowu Xue, Mengzhao Sun, Zixuan Zhou et al.
- **标签**: `cond-mat.mtrl-sci` `physics.chem-ph`
- **AI摘要**: 通过Pt晶面调控实现扭转石墨烯的可控生长
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 揭示了晶面动力学机制，实现了高精度扭转角生长，方法创新且严谨。

### 5. **[Inductance Meets Memory in the Quantum Magnet Mn3Si2Te6](https://arxiv.org/abs/2604.15635v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Tristan R. Cao, Gabriel Schebel, Arabella Quane et al.
- **标签**: `cond-mat.str-el` `physics.app-ph`
- **AI摘要**: Mn3Si2Te6中轨道电流实现电感与忆阻特性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 量子材料轨道自由度研究具突破性，逻辑严密且应用潜力大。

## Gear dynamic

### 1. **[Closing the Theory-Practice Gap in Spiking Transformers via Effective Dimension](https://arxiv.org/abs/2604.15769v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-17
- **作者**: Dongxin Guo, Jikun Wu, Siu Ming Yiu
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出脉冲Transformer的理论框架与有效维度分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，通过有效维度解释了脉冲效率，实验验证充分。

### 2. **[A Structure-Preserving Graph Neural Solver for Parametric Hyperbolic Conservation Laws](https://arxiv.org/abs/2604.15617v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-17
- **作者**: Jiamin Jiang, Shanglin Lv, Jingrun Chen
- **标签**: `physics.comp-ph` `cs.LG` `math.NA`
- **AI摘要**: 提出一种保结构的图神经网络求解器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合数值方法与GNN，在复杂流体模拟中表现优异

### 3. **[Quantum-Inspired Simulation of 2D Turbulent Rayleigh-Bénard Convection](https://arxiv.org/abs/2604.16179v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Nis-Luca van Hülst, Mario Guillaume Cecile, Hai-Yen Van et al.
- **标签**: `physics.flu-dyn` `physics.comp-ph` `quant-ph`
- **AI摘要**: 量子启发模拟湍流瑞利-贝纳尔对流
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖性高，方法有效，结果可靠，清晰易懂

### 4. **[Laser-written reconfigurable energy landscapes and programmable Moiré spin textures](https://arxiv.org/abs/2604.16120v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Matteo Panzeri, Piero Florio, Davide Girardi et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 激光重构磁性势能实现可编程自旋纹理
<details>
<summary>原始摘要</summary>
...
### 5. **[AEGIS: Anchor-Enforced Gradient Isolation for Knowledge-Preserving Vision-Language-Action Fine-Tuning](https://arxiv.org/abs/2604.16067v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-17
- **作者**: Guransh Singh
- **标签**: `cs.LG` `cs.CV`
- **AI摘要**: 提出AEGIS正交投影法以防VLM微调遗忘
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，通过梯度隔离有效解决了多模态模型微调中的灾难性遗忘问题。
