...
### 1. **[Discovering Novel LLM Experts via Task-Capability Coevolution](https://arxiv.org/abs/2604.14969v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Andrew Dai, Boris Meinardus, Ciaran Regan et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出AC/DC框架实现LLM与任务协同进化
<details>
...
- **评分理由**: 通过模型合并与数据生成实现持续进化，创新性强且实验扎实。

### 2. **[Open-Set Vein Biometric Recognition with Deep Metric Learning](https://arxiv.org/abs/2604.14874v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Paweł Pilarek, Marcel Musiałek, Anna Górska
- **标签**: `cs.CV`
- **AI摘要**: 基于深度度量学习的开放集静脉识别方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验严谨，在多数据集上表现优异，实用性强。
...
- **评分理由**: 通过梯度几何重塑解决遗忘任务中的冲突，方法创新且实验扎实。

### 5. **[Sequence Search: Automated Sequence Design using Neural Architecture Search](https://arxiv.org/abs/2604.14788v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Rokgi Hong, Hongjun An, Sooyeon Ji et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出基于神经架构搜索的自动核磁共振序列设计框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，通过微分模拟器实现序列自动生成，具有高实用价值。

## Gear dynamic

### 1. **[Segment-Level Coherence for Robust Harmful Intent Probing in LLMs](https://arxiv.org/abs/2604.14865v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Xuanli He, Bilgehan Sel, Faizan Ali et al.
- **标签**: `cs.CL` `cs.CR`
- **AI摘要**: 提出片段级相干性检测以提升LLM有害意图识别鲁棒性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，在CBRN安全领域具有显著应用价值
...
- **标签**: `cs.AI`
- **AI摘要**: 提出医学文档评估新框架，纠正了临床推理被误判为幻觉的问题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究揭示了现有评估指标对临床推理的误判，方法论严谨且具有重要临床应用价值。

### 3. **[Agent-Aided Design for Dynamic CAD Models](https://arxiv.org/abs/2604.15184v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-16
- **作者**: Mitch Adler, Matthew Russo, Michael Cafarella
- **标签**: `cs.AI`
- **AI摘要**: 提出AADvark系统实现动态CAD装配体生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过集成约束求解器解决动态装配难题，创新性强。

### 4. **[Compressing Sequences in the Latent Embedding Space: $K$-Token Merging for Large Language Models](https://arxiv.org/abs/2604.15153v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-16
- **作者**: Zihao Xu, John Harvill, Ziwei Fan et al.
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出K-Token Merging实现高效潜在空间序列压缩
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，但分类不属给定领域

### 5. **[KVNN: Learnable Multi-Kernel Volterra Neural Networks](https://arxiv.org/abs/2604.15141v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-16
- **作者**: Haoyu Yun, Hamid Krim, Yufang Bao
- **标签**: `cs.CV`
- **AI摘要**: 提出kVNN以多核Volterra提升模型效率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多核Volterra结构优化卷积层，兼顾性能与计算效率。
