...
### 1. **[Gradient-Informed Bayesian and Interior Point Optimization for Efficient Inverse Design in Nanophotonics](https://arxiv.org/abs/2602.18148v2)**
- **评分**: ⭐ 86/100 | **日期**: 2026-02-20
- **作者**: Yannik Mahlau, Yannick Augenstein, Tyler W. Hughes et al.
- **标签**: `physics.optics` `cs.LG`
- **AI摘要**: 提出BONNI算法用于光子器件逆设计
<details>
...
### 2. **[LAGO: A Local-Global Optimization Framework Combining Trust Region Methods and Bayesian Optimization](https://arxiv.org/abs/2603.02970v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-03-03
- **作者**: Eliott Van Dieren, Tommaso Vanzan, Fabio Nobile
- **标签**: `cs.LG` `math.OC`
- **AI摘要**: LAGO结合了贝叶斯优化和信任域方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖的混合优化框架，在探索和利用之间取得了良好平衡，具有较高的实用性和清晰度。

### 3. **[Deep learning-guided evolutionary optimization for protein design](https://arxiv.org/abs/2603.02753v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-03-03
- **作者**: Erik Hartman, Di Tang, Johan Malmström
- **标签**: `cs.LG` `q-bio.QM` `stat.ML`
- **AI摘要**: 提出结合贝叶斯优化与遗传算法的蛋白质设计框架
<details>
<summary>原始摘要</summary>
...
### 4. **[Randomized Kriging Believer for Parallel Bayesian Optimization with Regret Bounds](https://arxiv.org/abs/2603.01470v2)**
- **评分**: ⭐ 82/100 | **日期**: 2026-03-02
- **作者**: Shuhei Sugiura, Ichiro Takeuchi, Shion Takeno
- **标签**: `cs.LG` `stat.ML`
- **AI摘要**: 提出随机克里金信念并行贝叶斯优化方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖性高，理论实验俱佳，实用性强，清晰易懂

### 5. **[Human-AI Collaborative Autonomous Experimentation With Proxy Modeling for Comparative Observation](https://arxiv.org/abs/2603.12618v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-03-13
- **作者**: Arpan Biswas, Hiroshi Funakubo, Yongtao Liu
- **标签**: `cs.LG`
- **AI摘要**: 提出代理模型贝叶斯优化实现人机协作自主实验
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 新颖性高，实用性强，方法严谨，表述清晰，人机协作是亮点
