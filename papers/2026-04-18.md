...
### 1. **[Meituan Merchant Business Diagnosis via Policy-Guided Dual-Process User Simulation](https://arxiv.org/abs/2604.15190v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Ziyang Chen, Renbing Chen, Daowei Li et al.
- **标签**: `cs.AI` `cs.CL`
- **AI摘要**: 提出PGHS框架实现商家业务诊断模拟
<details>
...
- **评分理由**: 结合LLM推理与ML拟合，在工业场景验证有效

### 2. **[Class Unlearning via Depth-Aware Removal of Forget-Specific Directions](https://arxiv.org/abs/2604.15166v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Arman Hatami, Romina Aalishah, Ilya E. Monosov
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出DAMP方法实现高效且深度的机器遗忘
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了深度表征遗忘问题

### 3. **[IG-Search: Step-Level Information Gain Rewards for Search-Augmented Reasoning](https://arxiv.org/abs/2604.15148v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Zihan Liang, Yufei Ma, Ben Chen et al.
- **标签**: `cs.AI` `cs.CL` `cs.IR`
- **AI摘要**: 提出IG-Search通过信息增益实现搜索增强推理的细粒度奖励。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效解决了搜索查询的信用分配问题。

### 4. **[DiscoTrace: Representing and Comparing Answering Strategies of Humans and LLMs in Information-Seeking Question Answering](https://arxiv.org/abs/2604.15140v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Neha Srikanth, Jordan Boyd-Graber, Rachel Rudinger
- **标签**: `cs.CL`
- **AI摘要**: 提出DiscoTrace分析人类与LLM回答策略的差异
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且分析深入，揭示了LLM在回答策略上的局限性

### 5. **[No More Guessing: a Verifiable Gradient Inversion Attack in Federated Learning](https://arxiv.org/abs/2604.15063v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Francesco Diana, Chuan Xu, André Nusser et al.
- **标签**: `cs.LG` `cs.AI` `cs.CR`
- **AI摘要**: 提出可验证梯度反演攻击以破解表格数据隐私
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地引入几何验证机制，显著提升了攻击准确度与可信度。

## Gear dynamic

### 1. **[Predicting Power-System Dynamic Trajectories with Foundation Models](https://arxiv.org/abs/2604.14991v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Haoran Li, Lihao Mai, Chenhan Xiao et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出LASS-ODE-Power模型实现电力系统动态轨迹预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且泛化性强，实验充分，具有较高应用价值。

### 2. **[SOLIS: Physics-Informed Learning of Interpretable Neural Surrogates for Nonlinear Systems](https://arxiv.org/abs/2604.14879v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
...
- **评分理由**: 方法创新性强，有效解决了黑盒模型与物理约束的平衡问题。

### 3. **[Blue Data Intelligence Layer: Streaming Data and Agents for Multi-source Multi-modal Data-Centric Applications](https://arxiv.org/abs/2604.15233v1)**
...
- **评分理由**: 系统架构创新且实用，但实验验证部分略显不足

### 4. **[RL-STPA: Adapting System-Theoretic Hazard Analysis for Safety-Critical Reinforcement Learning](https://arxiv.org/abs/2604.15201v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-16
- **作者**: Steven A. Senczyszyn, Timothy C. Havens, Nathaniel Rice et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出RL-STPA框架以提升强化学习安全性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性地将STPA引入RL安全评估，方法论创新且实用。

### 5. **[Unsupervised Skeleton-Based Action Segmentation via Hierarchical Spatiotemporal Vector Quantization](https://arxiv.org/abs/2604.15196v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-16
- **作者**: Umer Ahmed, Syed Ahmed Mahmood, Fawad Javed Fateh et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出分层时空向量量化动作分割框架
<details>
<summary>原始摘要</summary>
