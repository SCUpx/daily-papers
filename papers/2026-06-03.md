...
### 1. **[Towards Automated Discovery: A Review of Generative Models, Multimodal Learning and Closed-Loop Workflows in Inverse Materials Design](https://arxiv.org/abs/2606.02507v1)**
...
- **评分理由**: 系统梳理了生成模型在材料发现中的应用，学术价值高。

### 2. **[Transferring Information Across Interventions in Causal Bayesian Optimization](https://arxiv.org/abs/2606.01457v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-31
- **作者**: Mohammad Ali Javidian
- **标签**: `cs.AI` `cs.LG` `stat.ML`
- **AI摘要**: 提出图耦合因果贝叶斯优化，实现干预间信息迁移。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且理论严谨，有效提升了因果优化效率。

### 3. **[Local Preferential Bayesian Optimization](https://arxiv.org/abs/2606.02351v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-01
- **作者**: Johanna Menn, Miriam Kober, Paul Brunzema et al.
- **标签**: `cs.LG` `stat.ML`
- **AI摘要**: 提出局部偏好贝叶斯优化，提升高维优化效率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入局部搜索策略，实验严谨且实用性强。

### 4. **[Evidence-Gated LLM Priors for Multi-Objective Bayesian Optimization](https://arxiv.org/abs/2606.01730v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-01
- **作者**: Jiangyu Chen, Banyi
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 提出多目标贝叶斯优化中的LLM专家权重动态校准机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，但在多目标场景下的鲁棒性分析仍有提升空间

### 5. **[Optimal-Point Variance Reduction For Bayesian Optimization With Regret Guarantee](https://arxiv.org/abs/2606.00956v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-31
- **作者**: Shion Takeno
- **标签**: `cs.LG`
- **AI摘要**: 提出OVR方法并提供遗憾界理论保证
<details>
<summary>原始摘要</summary>
