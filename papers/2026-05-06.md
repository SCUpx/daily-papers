...
### 1. **[Provable and scalable quantum Gaussian processes for quantum learning](https://arxiv.org/abs/2605.00099v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-30
- **作者**: Jonas Jäger, Paolo Braccia, Pablo Bermejo et al.
- **标签**: `quant-ph` `cs.LG` `stat.ML`
- **AI摘要**: 提出量子高斯过程学习框架
<details>
...
- **评分理由**: 理论创新性强且具备物理可解释性，实验验证充分。

### 2. **[Discovery of Polymer Electrolytes with Bayesian Optimization and High-Throughput Molecular Dynamics simulations](https://arxiv.org/abs/2602.17595v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-02-19
- **作者**: Antonia S. Kuhn, Jurğis Ruža, KyuJung Jun et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 利用贝叶斯优化加速电解质材料发现
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且流程严谨，有效提升了材料筛选效率。

### 3. **[Inducing Permutation Invariant Priors in Bayesian Optimization for Carbon Capture and Storage Applications](https://arxiv.org/abs/2605.02409v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-04
- **作者**: Sofianos Panagiotis Fotias, Vassilis Gaganis
- **标签**: `cs.LG`
- **AI摘要**: 提出GP-Perm核函数以处理置换不变性优化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对CCS应用提出创新核函数，实验设计严谨且实用性强。

### 4. **[Active Reasoning Vision-Language Models via Sequential Experimental Design](https://arxiv.org/abs/2605.01345v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-02
- **作者**: Anjie Liu, Ziqin Gong, Yan Song et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 提出基于序列实验设计的视觉推理框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过S-BOED解决视觉带宽瓶颈，方法创新且实验扎实。

### 5. **[Decouple before Integration: Test-time Synthesis of SFT and RLVR Task Vectors](https://arxiv.org/abs/2605.00610v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-01
- **作者**: Chaohao Yuan, Chenghao Xiao, Yu Rong et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出DoTS框架，通过任务向量合成实现SFT与RLVR能力融合
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过任务向量解耦实现推理时融合，方法创新且实验扎实

## Mixed lubrication

### 1. **[Dispersion of multiple charged species in an axially symmetric slowly varying channel](https://arxiv.org/abs/2605.00653v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-01
- **作者**: Thakurdas Mahata, Anirban Chatterjee, Ameeya Kumar Nayak
- **标签**: `cond-mat.soft`
- **AI摘要**: 提出多组分离子在变截面通道中的有效输运模型
<details>
<summary>原始摘要</summary>
