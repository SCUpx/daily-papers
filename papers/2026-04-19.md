...
- **评分理由**: 创新性强，显著提升大模型张量计算性能

### 2. **[Generalization in LLM Problem Solving: The Case of the Shortest Path](https://arxiv.org/abs/2604.15306v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Yao Tong, Jiayuan Ye, Anastasia Borovykh et al.
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 通过最短路径任务揭示LLM泛化能力边界与局限
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，深入剖析了LLM在逻辑推理上的泛化瓶颈。

### 3. **[Atropos: Improving Cost-Benefit Trade-off of LLM-based Agents under Self-Consistency with Early Termination and Model Hotswap](https://arxiv.org/abs/2604.15075v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Naryeong Kim, Shin Yoo
- **标签**: `cs.SE` `cs.LG`
- **AI摘要**: 提出Atropos框架优化LLM代理的成本效益。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过GCN预测与模型热切换显著降低了推理成本并提升了成功率。

### 4. **[Towards Faster Language Model Inference Using Mixture-of-Experts Flow Matching](https://arxiv.org/abs/2604.15009v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Aihua Li
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 提出MoE流匹配框架实现高效非自回归语言建模
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入MoE优化流匹配，显著提升推理速度与生成质量。

### 5. **[SAGER: Self-Evolving User Policy Skills for Recommendation Agent](https://arxiv.org/abs/2604.14972v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Zhen Tao, Riwei Lai, Chenyun Yu et al.
- **标签**: `cs.IR`
- **AI摘要**: 提出SAGER框架实现个性化推荐推理策略自进化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将个性化策略引入推荐推理，实验扎实且效果显著。

## Gear dynamic

### 1. **[Can LLMs Score Medical Diagnoses and Clinical Reasoning as well as Expert Panels?](https://arxiv.org/abs/2604.14892v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-04-16
- **作者**: Amy Rouillard, Sitwala Mundiab, Linda Camarab et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: LLM评审团可作为医疗诊断评估的可靠专家代理
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，创新性强，对医疗AI评估具有高实用价值
...
### 3. **[GlobalSplat: Efficient Feed-Forward 3D Gaussian Splatting via Global Scene Tokens](https://arxiv.org/abs/2604.15284v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Roni Itkin, Noam Issachar, Yehonatan Keypur et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出GlobalSplat实现高效3D高斯溅射重建
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过全局场景标记实现紧凑且高效的视图合成，创新性强。

### 4. **[R3D: Revisiting 3D Policy Learning](https://arxiv.org/abs/2604.15281v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Zhengdong Hong, Shenrui Wu, Haozhe Cui et al.
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 提出基于Transformer的3D策略学习架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性解决了3D策略训练不稳定与过拟合问题，性能显著提升。

### 5. **[Quality-Aware Calibration for AI-Generated Image Detection in the Wild](https://arxiv.org/abs/2604.15027v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-16
- **作者**: Fabrizio Guillaro, Vincenzo De Rosa, Davide Cozzolino et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出利用近邻重复图像质量校准的AI生成图像检测框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决现实场景中图像退化问题，实验严谨且数据集丰富。
