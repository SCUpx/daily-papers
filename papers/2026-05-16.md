...
### 1. **[Bayesian Model Merging](https://arxiv.org/abs/2605.12843v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-13
- **作者**: Kaiyang Li, Shaobo Han, Qing Su et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出贝叶斯模型合并框架，实现高效多任务模型融合。
<details>
...
- **评分理由**: 方法创新且实验扎实，在多任务合并领域表现优异。

### 2. **[Kernel-based guarantees for nonlinear parametric models in Bayesian optimization](https://arxiv.org/abs/2605.13160v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-13
- **作者**: Rafael Oliveira
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出非线性参数模型的核方法理论框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了非线性模型在贝叶斯优化中理论保证的空白

### 3. **[Empowering LLMs for Structure-Based Drug Design via Exploration-Augmented Latent Inference](https://arxiv.org/abs/2601.15333v2)**
- **评分**: ⭐ 82/100 | **日期**: 2026-01-20
- **作者**: Xuanning Hu, Anchen Li, Qianli Xing et al.
- **标签**: `cs.LG` `cs.AI` `q-bio.QM`
- **AI摘要**: 提出ELILLM框架优化药物设计
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，在药物发现领域具有应用潜力。

### 4. **[Manifold Sampling via Entropy Maximization](https://arxiv.org/abs/2605.12338v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-12
- **作者**: Cornelius V. Braun, Tilman Burghoff, Marc Toussaint
- **标签**: `cs.LG` `cs.AI` `stat.CO`
- **AI摘要**: 提出MASEM算法解决多连通域流形采样问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且理论完备，在机器人领域应用潜力大。

### 5. **[Accelerating battery research with an AI interface between FINALES and Kadi4Mat](https://arxiv.org/abs/2605.00909v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-29
- **作者**: Giovanna Tosato, Leon Merker, Monika Vogler et al.
- **标签**: `cs.AI` `cond-mat.mtrl-sci` `cs.LG`
- **AI摘要**: 构建AI接口实现电池实验自动化优化
<details>
<summary>原始摘要</summary>
