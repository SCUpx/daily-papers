...
- **AI摘要**: 揭示多模态MoE模型推理失效的路由分心机制，并提出干预方法。
<details>
...
- **评分理由**: 论文深入分析了MoE架构的路由机制缺陷，实验设计严谨，提出的干预方法具有显著的性能提升，创新性与实用性兼备。
...
- **标签**: `cs.CV` `cs.AI` `cs.CL`
- **AI摘要**: 提出G$^2$RPO算法解决多模态RL训练中的奖励方差与平衡难题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入高斯分布匹配优化GRPO，理论创新性强，实验覆盖18个基准，方法论严谨且具备极高实用价值。
...
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出HDPO框架，通过解耦优化目标解决多模态智能体工具滥用问题。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地将工具效率从标量奖励中解耦，方法论严谨且针对性强，有效提升了智能体元认知能力。
...
- **评分理由**: 该工作填补了多模态生成评估的空白，方法论严谨且具有实用价值，但在创新性上属于对现有评估范式的系统性整合。
...
- **标签**: `cs.CV`
- **AI摘要**: 提出NUMINA框架，通过注意力机制引导实现视频生成中的精确数量控制。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且无需训练，解决了扩散模型计数难题，实验验证充分，逻辑清晰，具有很高的实用价值。
...
- **AI摘要**: 提出SIM1框架，通过物理对齐的仿真引擎实现可变形物体操作的高效数据扩展。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该研究有效解决了柔性体操作的数据瓶颈，方法论严谨且实验结果显著，在具身智能领域具有很高的实用价值与创新性。
...
- **标签**: `cs.CV` `cs.GR`
- **AI摘要**: 提出Skelebones骨架绑定系统，实现4D高斯表征的高保真重定向与可控动画。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，通过骨架与骨骼解耦实现动态压缩；实验对比充分，在非刚性形变处理上表现优异，具有极高的学术与应用价值。
...
- **评分理由**: 方法创新性强，针对事件相机特性设计，实验结果显著优于现有方案，具有极高的工业应用潜力。
...
- **标签**: `cs.CV`
- **AI摘要**: 通过解耦“脱衣”与“稠密拟合”模块，实现对穿衣人体的高鲁棒性与高表现力拟合。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法设计巧妙，通过模块化训练提升了泛化性，实验数据详实，在复杂场景下表现优异，属于领域内扎实的改进工作。
...
- **标签**: `cs.CV`
- **AI摘要**: 提出神经全局上下文表示与测试时训练，提升大规模场景重建精度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过测试时自监督优化解决长序列重建一致性问题，方法创新且实验扎实，具有较好的工程实用价值。
