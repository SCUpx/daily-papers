...
### 1. **[Regime-Conditioned Evaluation in Multi-Context Bayesian Optimization](https://arxiv.org/abs/2605.04895v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-06
- **作者**: Noel Thomas
- **标签**: `cs.LG` `stat.ML`
- **AI摘要**: 提出基于状态的贝叶斯优化评估框架
<details>
...
- **评分理由**: 揭示了预算与先验对算法排名的影响，方法论严谨且实用。

### 2. **[ORTHOBO: Orthogonal Bayesian Hyperparameter Optimization](https://arxiv.org/abs/2605.06454v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-07
- **作者**: Maresa Schröder, Pascal Janetzky, Michael Klar et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出正交贝叶斯优化框架以降低采集函数估计方差
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过控制变量法有效降低蒙特卡洛噪声，理论与实验扎实。

### 3. **[Decoupled PFNs: Identifiable Epistemic-Aleatoric Decomposition via Structured Synthetic Priors](https://arxiv.org/abs/2605.06413v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-07
- **作者**: Richard Bergna, Stefan Depeweg, José Miguel Hernández-Lobato
- **标签**: `stat.ML` `cs.LG`
- **AI摘要**: 提出解耦PFN以分离认知与偶然不确定性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且在贝叶斯优化中表现优异，论证严谨。

### 4. **[AutoRAGTuner: A Declarative Framework for Automatic Optimization of RAG Pipelines](https://arxiv.org/abs/2605.02967v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-03
- **作者**: Xintan Zeng, Yongchao Liu, Yice Luo et al.
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 提出自动化RAG流水线优化框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过声明式配置和贝叶斯优化提升RAG开发效率与性能

### 5. **[Bayesian Optimization in Linear Time](https://arxiv.org/abs/2605.00237v1)**
