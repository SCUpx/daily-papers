...
### 1. **[Interpretable self-driving sputter epitaxy: from black-box optimization to human-usable growth rules](https://arxiv.org/abs/2602.22531v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-02-26
- **作者**: Yuki K. Wakabayashi, Yui Ogawa, Franz Benedict Romero et al.
...
- **评分理由**: 将黑盒优化转化为可解释规则，兼具创新与严谨性

### 2. **[Bayesian Optimality of In-Context Learning with Selective State Spaces](https://arxiv.org/abs/2602.17744v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-02-19
- **作者**: Di Zhang, Jiaqi Xing
- **标签**: `cs.LG` `cs.CL` `math.ST`
- **AI摘要**: 提出状态空间模型实现贝叶斯最优预测的理论框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，为上下文学习提供了全新的贝叶斯视角。

### 3. **[From Literature to Lab: Closed-Loop Advancement of Perovskite Solar Cells via Domain Knowledge Guided LLM](https://arxiv.org/abs/2602.04914v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-02-04
- **作者**: Penglei Sun, Shuyan Chen, Xiang Liu et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 提出PVK-LLM框架加速钙钛矿太阳能电池配方研发
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合领域知识与贝叶斯优化，显著提升材料研发效率与性能。

### 4. **[Automating Agent Hijacking via Structural Template Injection](https://arxiv.org/abs/2602.16958v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-02-18
- **作者**: Xinhao Deng, Jiaqing Wu, Miao Chen et al.
- **标签**: `cs.AI` `cs.LG`
- **AI摘要**: 提出Phantom框架实现自动化智能体劫持
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新利用结构化模板注入，实验严谨且实用性强

### 5. **[Accelerated Discovery of Cryoprotectant Cocktails via Multi-Objective Bayesian Optimization](https://arxiv.org/abs/2602.13398v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-02-13
- **作者**: Daniel Emerson, Nora Gaby-Biegel, Purva Joshi et al.
- **标签**: `cs.LG` `q-bio.QM`
- **AI摘要**: 利用多目标贝叶斯优化加速冷冻保护剂配方发现
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验验证充分，显著提升了研发效率

## Mixed lubrication

### 1. **[Coalescence of viscous blisters under an elastic sheet](https://arxiv.org/abs/2603.17731v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-03-18
- **作者**: W-E. Khatla, L. Duchemin, A. Eddi et al.
- **标签**: `physics.flu-dyn`
- **AI摘要**: 研究弹性薄膜下粘性气泡合并动力学
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合实验与润滑理论，模型严谨且物理机制清晰

### 2. **[Unstable Slip in Fault Gouge Driven by Temperature and Water](https://arxiv.org/abs/2603.16921v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-03-11
- **作者**: Li Wang, Jie Meng, Dongpo Wang et al.
- **标签**: `physics.geo-ph` `cond-mat.mtrl-sci`
- **AI摘要**: 揭示温度对断层泥界面水润滑的影响机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 分子动力学模拟揭示了界面水结构演化对摩擦的影响

### 3. **[Two-phase stratified MHD flows in rectangular ducts](https://arxiv.org/abs/2603.02853v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-03-03
- **作者**: Subham Pal, Ilya Barmak, Arseniy Parfenov et al.
- **标签**: `physics.flu-dyn`
- **AI摘要**: 研究矩形管道内两相分层MHD流动的特性与影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论模型严谨，揭示了磁场与壁面电导率对流体的影响

### 4. **[Exact response functions for a compressible thin fluid layer with odd viscosity](https://arxiv.org/abs/2602.18136v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-02-20
- **作者**: Abdallah Daddi-Moussa-Ider, Yuto Hosaka, Shigeyuki Komura
- **标签**: `cond-mat.soft` `physics.flu-dyn`
- **AI摘要**: 推导了可压缩奇粘性薄流体层的精确格林函数解。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，为手性微流体动力学提供了重要解析工具。

### 5. **[Ground effect on Undulation and pumping near surfaces](https://arxiv.org/abs/2602.16978v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-02-19
- **作者**: Sunghwan Jung
- **标签**: `physics.flu-dyn`
- **AI摘要**: 揭示生物近壁面运动与流体泵送的统一物理机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合理论模型与生物实验，系统性分析了地面效应的影响，严谨且具有启发性。

## Super Lubricating

### 1. **[When Is Structural Lubricity Load Independent? The Role of Contact Geometry and Elastic Compliance](https://arxiv.org/abs/2602.16474v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-02-18
- **作者**: Hongyu Gao
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示接触几何与弹性形变对结构超润滑的影响机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过分子动力学深入探讨了载荷无关摩擦的边界条件，理论严谨且具有重要物理意义。

### 2. **[Grip as Needed, Glide on Demand: Ultrasonic Lubrication for Robotic Locomotion](https://arxiv.org/abs/2602.15608v2)**
- **评分**: ⭐ 82/100 | **日期**: 2026-02-17
- **作者**: Mostafa A. Atalla, Daan van Bemmel, Jack Cummings et al.
- **标签**: `cs.RO` `physics.app-ph`
- **AI摘要**: 提出超声润滑主动控制机器人摩擦力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，实验验证充分，应用潜力广阔。

### 3. **[Dynamic Wettability Modulation of Textured, Soft and LIS Interfaces Using Electrowetting](https://arxiv.org/abs/2603.05297v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-03-05
- **作者**: Deepak J., Suman Chakraborty, Shubham S. Ganar et al.
- **标签**: `cond-mat.soft` `physics.flu-dyn`
- **AI摘要**: 揭示了润滑表面电润湿诱导液滴侧向喷射的新机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究发现微结构与润滑界面下的非对称电毛细力驱动机制，创新性强且实验严谨。

### 4. **[GraphAgents: Knowledge Graph-Guided Agentic AI for Cross-Domain Materials Design](https://arxiv.org/abs/2602.07491v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-02-07
- **作者**: Isabella A. Stewart, Tarjei Paule Hage, Yu-Chuan Hsu et al.
...
- **评分理由**: 结合知识图谱与多智能体，有效提升材料发现效率

### 5. **[Effective longitudinal slip over grooves encapsulated by a nearly inviscid lubricant](https://arxiv.org/abs/2601.20581v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-01-28
- **作者**: Ory Schnitzer, Ehud Yariv
- **标签**: `physics.flu-dyn`
- **AI摘要**: 揭示了近无粘润滑剂在沟槽表面的滑移效应
<details>
<summary>原始摘要</summary>
