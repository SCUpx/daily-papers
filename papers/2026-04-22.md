...
### 1. **[Polysemantic Experts, Monosemantic Paths: Routing as Control in MoEs](https://arxiv.org/abs/2604.17837v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-20
- **作者**: Charles Ye, Bo Yuan, Lee Sharkey
- **标签**: `cs.AI` `cs.CL` `cs.LG`
- **AI摘要**: 提出MoE路由控制解耦机制，实现语义路径解释
<details>
...
- **评分理由**: 创新性提出控制与内容解耦，显著提升MoE可解释性

### 2. **[Faster by Design: Interactive Aerodynamics via Neural Surrogates Trained on Expert-Validated CFD](https://arxiv.org/abs/2604.18491v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-04-20
- **作者**: Nicholas Thumiger, Andrea Bartezzaghi, Mattia Rigotti et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出GIST模型实现赛车气动实时仿真
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强且工业验证扎实，有效提升设计效率

### 3. **[Characterizing Model-Native Skills](https://arxiv.org/abs/2604.17614v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-04-19
- **作者**: Feiyang Kang, Mahavir Dabas, Myeongseob Ko et al.
- **标签**: `cs.AI` `cs.CL` `cs.LG`
- **AI摘要**: 提出基于模型表征的技能表征方法以优化模型干预。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，在模型干预领域具有显著实用价值。

### 4. **[Bounded Ratio Reinforcement Learning](https://arxiv.org/abs/2604.18578v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Yunke Ao, Le Chen, Bruce D. Lee et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出BRRL框架以优化策略更新并提升强化学习稳定性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨且在多项基准测试中表现优于PPO

### 5. **[When Can LLMs Learn to Reason with Weak Supervision?](https://arxiv.org/abs/2604.18574v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Salman Rahman, Jingyan Shen, Anna Mordvina et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 揭示弱监督下LLM推理泛化机制与训练策略
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性研究了RLVR泛化规律，方法论严谨且具启发性。

## Mixed lubrication

### 1. **[DeepRitzSplit Neural Operator for Phase-Field Models via Energy Splitting](https://arxiv.org/abs/2604.18261v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-20
- **作者**: Chih-Kang Huang, Ludovick Gagnon, Miha Založnik et al.
- **标签**: `math.AP` `cs.LG` `math.NA`
- **AI摘要**: 提出DeepRitzSplit神经算子加速相场模拟
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合能量分裂与物理信息学习，提升了模拟效率与泛化性

### 2. **[Approximate Hamiltonian Simulation Algorithm for Efficient Fluid Quantum Simulations](https://arxiv.org/abs/2604.17489v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-19
- **作者**: Zhiyuan Zhang, Bolin Zhang, Yongguang Lv et al.
- **标签**: `quant-ph` `physics.comp-ph` `physics.flu-dyn`
- **AI摘要**: 提出近似算子优化方案以降低流体量子模拟电路深度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法显著降低了电路复杂度，实验验证有效，但未涉及指定类别。

### 3. **[$μ$-FlowNet: A Deep Learning Approach for Mapping Flow Fields in Irregular Microchannels Using an Attention-based U-Net Encoder-Decoder Architecture](https://arxiv.org/abs/2604.17575v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-04-19
- **作者**: Ganesh Sahadeo Meshram, Suman Chakraborty, Nishant Sinha et al.
- **标签**: `cs.CE`
- **AI摘要**: 利用注意力U-Net实现微流道流场高效预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型创新性较好，但应用领域与所选分类不匹配。

## EHL

### 1. **[Neural Shape Operator Surrogates -- Expression Rate Bounds](https://arxiv.org/abs/2604.18012v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
...
- **评分理由**: 理论严谨，为形状参数化PDE求解提供数学支撑

### 2. **[Three-dimensional visualization of lattice defects in $β$-Ga$_2$O$_3$ via synchrotron-radiation Borrmann-effect X-ray topo-tomography](https://arxiv.org/abs/2604.17826v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Yongzhao Yao, Daiki Katsube, Hirotaka Yamaguchi et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 利用同步辐射实现氧化镓位错三维成像
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 首次实现氧化镓位错三维重构，方法创新且实用性强。

### 3. **[Microscopic Theory of Acoustic Phonon Scattering by Charge-Density-Wave Fluctuations](https://arxiv.org/abs/2604.17655v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-19
- **作者**: Han Huang
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci` `cond-mat.str-el`
- **AI摘要**: 建立电荷密度波散射声子微观理论
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论框架严谨，统一了散射、谱学与热输运分析

### 4. **[Evaluating dispersion models for ab initio simulation of G-I and G-II molten fluoride salts](https://arxiv.org/abs/2604.18139v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-20
- **作者**: Shubhojit Banerjee, Rajni Chahal Crockett, Julian Barra et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.other`
- **AI摘要**: 系统评估了色散修正对熔盐模拟的影响。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨且对熔盐计算具有重要的指导意义。

### 5. **[Anisotropic Electrostatic-Elastic Softening and Stability in Charged Colloidal Crystals](https://arxiv.org/abs/2604.17541v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-19
- **作者**: Hao Wu, Zhong-Can Ou-Yang
- **标签**: `cond-mat.soft` `cond-mat.mtrl-sci` `cond-mat.stat-mech`
- **AI摘要**: 提出带电胶体晶体各向异性弹性失稳的解析判据
<details>
<summary>原始摘要</summary>

Charged colloidal crystals exhibit a subtle interplay between electrostatic screening and elastic deformation. In an anisotropic elastic medium the coupling between dilation and the local ionic environment becomes direction dependent, leading to a preferential softening of the longitudinal acoustic response along specific crystallographic axes. This article provides a self-contained derivation of the long-wavelength static stability condition for cubic crystals subject to a generic electrostatic-elastic coupling. Starting from an effective static elastic tensor renormalized by a scalar coupling constant $λ_g$, we obtain an explicit condition for the onset of a homogeneous instability: the direction $\hat{\mathbf{k}}$ that first loses rigidity is determined by the inverse Christoffel matrix evaluated along that direction. Closed-form expressions for the critical coupling $λ_g^c$ are given for the $[100]$, $[110]$, and $[111]$ high-symmetry directions. We further provide a microscopic derivation of $λ_g$ from the Poisson-Boltzmann theory in a spherical Wigner-Seitz cell, linking the phenomenological constant to experimentally accessible parameters such as salt concentration, particle charge, and volume fraction. The analysis reveals that the most fragile direction can be identified without full lattice-dynamical calculations, and the associated unstable strain patterns are discussed. Numerical illustrations using experimentally measured elastic moduli of soft colloidal assemblies demonstrate the predictive power of the criterion. The present framework serves as a diagnostic tool for interpreting directional anomalies in static compressibility or low-frequency acoustic softening.
</details>
- **评分理由**: 理论推导严谨，建立了静电与弹性耦合的稳定性模型，具有较好的学术价值。

## Super Lubricating

### 1. **[Direct observation of quadruple spin-texture locking in a 2D d-wave altermagnet](https://arxiv.org/abs/2604.18337v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-20
- **作者**: Dan Mu, Bei Jiang, Qingchen Duan et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 首次观测到二维d波反铁磁体的四重自旋纹理锁定
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验技术突破，首次揭示了反铁磁体中的自旋晶格锁定机制

### 2. **[Moire Control of Alterelectric Quadrupolar Order](https://arxiv.org/abs/2604.18428v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-20
...
- **评分理由**: 理论创新性强，机制分析严谨，但应用潜力尚待验证。

### 3. **[Multipolar Piezoelectricity and Anisotropic Surface Transport in Alterelectrics](https://arxiv.org/abs/2604.18324v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-20
- **作者**: Amber Visser, Viktor Könye, Oleg Janson et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.str-el`
- **AI摘要**: 提出电极化反铁磁对应物及其各向异性输运特性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性提出电学对称性对应物，理论严谨且具有物理启发性。

### 4. **[Scale invariance of the polaron energy at the Mott-superfluid critical point](https://arxiv.org/abs/2604.17824v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-04-20
- **作者**: Matija Čufar, Ragheed Alhyder, C. J. Bradly et al.
- **标签**: `cond-mat.quant-gas` `physics.comp-ph`
- **AI摘要**: 利用极化子能谱探测量子相变临界特性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过量子蒙特卡洛模拟揭示了极化子能量的标度不变性，具有理论创新。

### 5. **[Crystallography, Lorentz violation, and the Standard-Model Extension](https://arxiv.org/abs/2604.17646v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-04-19
- **作者**: Marco Schreck, Rogeres A. da Silva Magalhães
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci` `hep-ph`
- **AI摘要**: 利用SME框架分析晶体光学性质与洛伦兹对称性破缺
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 跨学科方法新颖，理论严谨，但与所选类别关联度较低。

## Gear dynamic

### 1. **[Latent Phase-Shift Rollback: Inference-Time Error Correction via Residual Stream Monitoring and KV-Cache Steering](https://arxiv.org/abs/2604.18567v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-20
- **作者**: Manan Gupta, Dhruv Kumar
- **标签**: `cs.LG` `cs.AI` `cs.CL`
- **AI摘要**: 提出LPSR通过KV缓存回滚与转向纠正推理错误
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且性能显著提升，实验设计严谨详实

### 2. **[The strange mechanics of an elastic rod under null-resultant transverse loads](https://arxiv.org/abs/2604.17993v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-04-20
- **作者**: Davide Bigoni, Diego Misseroni, Andrea Piccolroaz
- **标签**: `physics.class-ph`
- **AI摘要**: 揭示了横向零合力载荷诱发弹性杆屈曲的力学机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，数值模拟与实验验证高度吻合，创新性强

### 3. **[Back into Plato's Cave: Examining Cross-modal Representational Convergence at Scale](https://arxiv.org/abs/2604.18572v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: A. Sophia Koepke, Daniil Zverev, Shiry Ginosar et al.
- **标签**: `cs.CV` `cs.AI` `cs.LG`
- **AI摘要**: 揭示跨模态表征收敛假设的局限性与脆弱性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过大规模实验挑战了现有表征收敛理论，论证严谨。

### 4. **[Learning the Riccati solution operator for time-varying LQR via Deep Operator Networks](https://arxiv.org/abs/2604.18507v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Jun Chen, Umberto Biccari, Junmin Wang
- **标签**: `math.OC` `cs.AI` `cs.LG`
- **AI摘要**: 利用DeepONet加速求解时变LQR问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且具备理论保障，在实时控制领域应用潜力大。

### 5. **[Consistent control of energy dissipation in non-spherical particle contact via a structure-preserving formulation](https://arxiv.org/abs/2604.18494v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-04-20
- **作者**: Y. T. Feng
- **标签**: `physics.comp-ph`
- **AI摘要**: 提出非球形颗粒接触耗能结构保持模型
<details>
<summary>原始摘要</summary>
