...
### 1. **[LABO: LLM-Accelerated Bayesian Optimization through Broad Exploration and Selective Experimentation](https://arxiv.org/abs/2605.22054v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Zhuo Chen, Xinzhe Yuan, Jianshu Zhang et al.
- **标签**: `cs.LG` `cs.AI`
- **AI摘要**: 提出LABO框架提升贝叶斯优化效率
<details>
...
- **评分理由**: 创新性引入LLM辅助决策，理论与实验支撑扎实

### 2. **[Beyond Scalar Objectives: Expert-Feedback-Driven Autonomous Experimentation for Scientific Discovery at the Nanoscale](https://arxiv.org/abs/2605.21820v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Ralph Bulanadi, Jefferey Baxter, Arpan Biswas et al.
- **标签**: `cs.LG` `cond-mat.mtrl-sci`
- **AI摘要**: 提出专家反馈驱动的纳米实验主动学习框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入人类专家知识，有效突破标量目标局限

### 3. **[KSOS-BO: Improving Sampling in Bayesian Optimization via Kernel Sum of Squares](https://arxiv.org/abs/2605.21179v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-20
- **作者**: Buqing Ou, Frederike Dümbgen
- **标签**: `cs.CE`
- **AI摘要**: 提出KSOS-BO框架优化贝叶斯采样
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验详实，显著提升了采样效率与收敛速度。

### 4. **[Regret-Based $(ε,δ)$-optimal Stopping Criteria for Bayesian Optimization](https://arxiv.org/abs/2605.22561v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Haowei Wang, Jingyi Wang, Qiyu Wei
- **标签**: `cs.LG`
- **AI摘要**: 提出基于遗憾界的高斯过程优化停止准则
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨且具备实际应用价值，创新性较好。

### 5. **[High-Throughput Bayesian Optimization of Cement-Salt Hydrates Composites for Seasonal Thermochemical Energy Storage](https://arxiv.org/abs/2605.19494v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-19
- **作者**: Alessio Mondello, Giulio Barletta, Luca Lavagna et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 利用贝叶斯优化提升水泥盐水合物储热性能
<details>
<summary>原始摘要</summary>
